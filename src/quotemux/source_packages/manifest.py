...
def _guess_handler_name(capability_id: str, available_handlers: set[str]) -> str:
    ...
    handler_map = {
        ...
        "stocks.indicators.money_flow.snapshot": "get_stock_money_flow_snapshot",
        "stocks.indicators.margin.snapshot": "get_stock_margin_snapshot",
        "stocks.finance.express.snapshot": "get_stock_express_snapshot",
        "stocks.finance.forecasts.snapshot": "get_stock_forecast_snapshot",
        ...
        "stocks.factors.strategy_window": "get_strategy_factor_window",
        ...
        "stocks.finance.pit.raw.period": "get_stock_financial_pit_period",
