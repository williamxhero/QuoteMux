...
def _guess_handler_name(capability_id: str, available_handlers: set[str]) -> str:
    ...
    handler_map = {
        ...
        "markets.calendar.trading.next": "get_trading_calendar",
        "markets.calendar.trading.previous": "get_trading_calendar",
        "markets.calendar.trading.yearly": "get_trading_calendar",
