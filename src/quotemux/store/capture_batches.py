...
FIRST_BATCH_CAPTURE_POLICIES = (
    FirstBatchCapturePolicy("stocks.quotes.intraday", CADENCE_DAILY, INTRADAY_RUN_TIME, None, None, None, 5, 20, "第一批：分钟 K 线，每天 20:00 补最近 5 个交易日"),
    ...
    FirstBatchCapturePolicy("boards.quotes.daily", CADENCE_DAILY, DEFAULT_RUN_TIME, None, None, None, 30, 1, "第一批：行业板块日线，每天补最近 30 个交易日"),
