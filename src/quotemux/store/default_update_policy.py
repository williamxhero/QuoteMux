...
CAPABILITY_UPDATE_POLICY_DEFAULTS = (
    ...
    _policy("concepts.indicators.money_flow", False, "daily", 180),
    ...
    _policy("markets.events.news", False, "daily", 30),
    ...
    _policy("stocks.finance.forecasts.snapshot", False, "daily", 365),
    _policy("stocks.finance.indicators", False, "daily", 365),
    _policy("stocks.finance.pit.raw.period", False, "daily", 365),
